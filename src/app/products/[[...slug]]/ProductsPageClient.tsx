...
export default function ProductsPageClient({ slug }: ProductsPageClientProps) {
    ...
    <div className="flex flex-col items-center relative size-full min-h-screen">
      ...
      <BreadcrumbStructuredData
        items={[
          ...
          { name: '제품소개', url: `${baseUrl}/products` },
          { name: category.name, url: `${baseUrl}/products/${category.slug}` },
          {
            name: product.name,
            url: `${baseUrl}/products/${category.slug}/${product.slug}`,
          },
