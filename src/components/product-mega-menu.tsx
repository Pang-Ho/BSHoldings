...
const getColumnLayout = () => {
  ...
  // Column 3: 초음파 센서, 고온 센서, 레벨 센서 (인덱스 3, 4, 5)
  if (productsData[3]) columns[2].push(productsData[3]);
  ...
  if (productsData[6]) columns[3].push(productsData[6]);
