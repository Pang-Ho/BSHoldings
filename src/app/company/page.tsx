    ...
    <div className="flex flex-col items-center relative size-full min-h-screen">
      ...
      <div className="flex flex-col grow items-center w-full pt-16 lg:pt-20">
        <div className="bg-white flex flex-col gap-6 md:gap-8 lg:gap-10 items-start px-4 md:px-6 py-12 md:py-16 lg:py-[68px] w-full max-w-[1200px]">
          ...
          <div className="bg-[var(--color-grey-50)] flex flex-col gap-3 items-center justify-center pb-12 md:pb-20 lg:pb-[140px] pt-12 md:pt-20 lg:pt-[120px] px-4 md:px-10 lg:px-20 w-full max-w-[900px] self-center">
            ...
            <div className="flex items-start justify-center pb-6 md:pb-10 pt-12 md:pt-20 lg:pt-[100px] px-0 w-full max-w-[700px]">
              ...
              >
                ...
                <div className="absolute font-medium leading-6 left-[-74px] text-xl text-[var(--color-text-basic)] whitespace-nowrap top-[436px] tracking-[-0.4px] leading-normal">
                ...
                <div className="absolute font-medium leading-6 left-[356px] text-xl text-[var(--color-text-basic)] whitespace-nowrap top-[436px] tracking-[-0.4px] leading-normal">
                  <p className="mb-0">
                ...
                <div className="absolute font-medium leading-6 left-[331px] text-xl text-[var(--color-text-basic)] whitespace-nowrap top-[-30px] tracking-[-0.4px] leading-normal">
